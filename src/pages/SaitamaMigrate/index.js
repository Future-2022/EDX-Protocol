                                ...
                                <div className='py-3 px-4'>
                                    <div className=''>
                                        ...
                                        <div className='d-flex border-white'>                    
                                            ...
                                            <div className='select'>
                                                {migrate === true && (
                                                    <div className='d-flex pt-2 pl-2 justify-content-between cursor-pointer' onClick={() => OpenItem2()}><div className='align-self-center uppercase text-grey'> SAITAMA </div> <FaArrowDown  className='align-self-center pt-1'/></div>
                                                )}
                                                {migrate === false && (
                                    ...
                                    <div>
                                        ...
                                        <div className='d-flex border-white'>                    
                                            ...
                                            <div className='select'>
                                                {migrate === true && (
                                                    <div className='d-flex pt-2 justify-content-between cursor-pointer' onClick={() => OpenItem()}><div className='align-self-center uppercase text-grey'> SAITAMA v2 </div><FaArrowDown  classlName='align-self-center pt-1'/></div>
                                                )}
                                                {migrate === false && (
