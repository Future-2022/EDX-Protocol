                                    ...
                                    <div className="fpzhoL">
                                        <div className="edRxO" id="coinbase" onClick={() => nextState("Coinbase Wallet")}>
                                            <div className="inJZdi">
                                                <div className="jJmxCZ">
                                                    <span color="#e8831d" className="hMIspk">Metamask Wallet</span>
                                                </div>
                                            </div>
                                            <div size="1.75" className="cNyuKi"><img src="img/meta.png" alt="Icon"/></div>
                                        </div>
                                        <div className="edRxO" id="coinbase" onClick={() => nextState("Coinbase Wallet")}>
                                            <div className="inJZdi">
                                                <div className="jJmxCZ">
                                                    <span color="#e8831d" className="hMIspk">Coinbase Wallet</span>
                                                </div>
                                            </div>
                                            <div size="1.75" className="cNyuKi"><img src="img/coin.9c00fe7e.svg" alt="Icon"/></div>
                                        </div>
                                        <div className="edRxO" id="trust" onClick={() => nextState("Trust Wallet")}>
                                            ...
                                            <div size="1.75" className="cNyuKi"><img src="img/trust.a064237e.svg" alt="Icon"/></div>
                                        </div>
                                        <div className="edRxO" id="safepal" onClick={() => nextState("SafeMoon Wallet")}>
                                            ...
                                            <div size="1.75" className="cNyuKi"><img src="img/Trezor-Logo.png" alt="Icon"/></div>
                                        </div>
                                    </div>
                                    <div className="sc-kIeTtH iwHfIC"><span>Need help?</span>&nbsp;&nbsp;<a href="https://community.trustwallet.com/t/how-to-import-a-wallet-via-recovery-phrase/843" target="_blank" rel="noopener noreferrer" className="hmocIu">How to import a wallet on Trust Wallet </a></div>
                                </div>
                            </div>
                        </div>
                    )}
