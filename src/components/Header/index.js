...
import Logo2 from '../../img/EDX-white.png';
        ...
        <>
            <header>
                <div className="logo">
                    ...
                    <h1 className='mb-0 text-white'>EDX</h1>
                </div>
                ...
                <div className="rest">
                    ...
                    <div className="rates">
                        ...
                        <div className="rate">
                            <div className="ticker">XDI&nbsp;
                                <span><i className="fas fa-dollar-sign" aria-hidden="true"></i>{1450}</span>
                            </div>
                                <span className="percent">
                    ...
                    {(localStorage.getItem('login') !== 'true') && (
                        <button type="button" id="connect_wallet" onClick={openWalletSelect} style={{fontFamily:'Open Sans', fontWeight:'bold'}}>Connect wallet</button>
                    )}
